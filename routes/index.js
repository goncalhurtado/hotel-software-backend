...
const { getAllBookings, createBooking, updateBooking, deleteBooking, getBookingById, getUpcomingBookings, getPastBookings, getCurrentBookings, getBookingReports } = require('../controllers/bookingController');
...
router.get("/booking/reports", authenticateAdmin, getBookingReports);
